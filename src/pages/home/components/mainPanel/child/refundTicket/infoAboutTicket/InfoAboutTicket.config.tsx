...
export const getConfig = (passenger: Passenger, direction: Direction): Config => ({
  fields: [
    ...
    },
    {
      ...
      value: passenger.ticket[direction]?.baggage?.rus || null,
    },
    {
      label: "Тип билета",
    ...
    },
    {
      ...
      value:
        passenger.ticket[direction].identification?.military?.number ||
        passenger.ticket[direction].identification?.student?.number ||
        "Null",
    },
    {
      label: "Тип оплаты",
